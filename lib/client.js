  ...
  module.exports = {
    ...
    apply(ctx) {
      ...
      const css = [
        ...
        '.gsv-search{font:inherit;font-size:13.5px;padding:10px 14px;border-radius:12px;width:100%;box-sizing:border-box;margin-top:14px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-label-tertiary);box-shadow:inset 0 1px 2px rgba(0,0,0,.04);transition:border-color .15s,box-shadow .15s,background .15s}',
        '.gsv-search:hover{background:var(--dsw-alias-bg-layer-1)}',
        '.gsv-search:focus{outline:none;border-color:' + BLUE + ';background:var(--dsw-alias-bg-layer-1);box-shadow:0 0 0 3px rgba(59,130,246,.16);caret-color:' + BLUE + '}',
