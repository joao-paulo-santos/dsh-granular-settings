  ...
  module.exports = {
    ...
    apply(ctx) {
      ...
      const css = [
        ...
        '.gsv-search{font:inherit;font-size:13px;padding:9px 14px;border-radius:10px;width:100%;box-sizing:border-box;margin-top:12px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-label-tertiary);transition:border-color .12s,box-shadow .12s}',
        '.gsv-search:focus{outline:none;border-color:' + BLUE + ';box-shadow:0 0 0 3px rgba(59,130,246,.15)}',
        '.gsv-search::placeholder{opacity:.5}',
