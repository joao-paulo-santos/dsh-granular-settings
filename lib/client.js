  ...
  module.exports = {
    ...
    apply(ctx) {
      ...
      const css = [
        ...
        '.gsv-search{font:inherit;font-size:13px;padding:7px 11px;border-radius:8px;width:min(280px,100%);margin-top:12px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-label-tertiary)}',
        '.gsv-search:focus{outline:1px solid var(--dsw-alias-label-primary)}',
