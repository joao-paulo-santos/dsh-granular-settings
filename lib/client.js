  ...
  module.exports = {
    ...
    apply(ctx) {
      ...
      const css = [
        ...
        '.gsv-info{flex:none;width:16px;height:16px;display:inline-flex;align-items:center;justify-content:center;font-size:11px;line-height:1;cursor:help;color:var(--dsw-alias-label-caption);border-radius:50%}',
