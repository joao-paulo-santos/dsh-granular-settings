  ...
  module.exports = {
    ...
    apply(ctx) {
      ...
      const css = [
        ...
        '.gsv-search{font:inherit;font-size:13.5px;padding:10px 14px;border-radius:6px;width:100%;box-sizing:border-box;margin-top:14px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-label-tertiary);transition:border-color .15s,background .15s}',
